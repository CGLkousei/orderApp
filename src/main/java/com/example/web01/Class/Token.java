...
public class Token {
    ...
    public static String generateToken(String restaurantId, String seatNo, long timestamp) throws Exception {
    ...
    public static boolean verifyToken(String restaurantId, String seatNo, long timestamp, String token) throws Exception {
